...
for (def index : (0..2)) {
    ...
    if (index == 0) {
        WebUI.scrollToElement(findTestObject('OR Cura/Page_CURA Healthcare Service/rb_Medicare'), 0)

        WebUI.click(findTestObject('OR Cura/Page_CURA Healthcare Service/rb_Medicare'))
    } else if (index == 1) {
        WebUI.scrollToElement(findTestObject('OR Cura/Page_CURA Healthcare Service/rb_Medicaid'), 0)

        WebUI.click(findTestObject('OR Cura/Page_CURA Healthcare Service/rb_Medicaid'))
    } else {
        WebUI.scrollToElement(findTestObject('OR Cura/Page_CURA Healthcare Service/rb_None'), 0)

        WebUI.click(findTestObject('OR Cura/Page_CURA Healthcare Service/rb_None'))
    }
    ...
    WebUI.click(findTestObject('OR Cura/Page_CURA Healthcare Service/btn_Go to Homepage'))
}
